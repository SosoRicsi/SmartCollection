...
namespace SosoRicsi\Collection;
 ...
 */
class SmartCollection implements ArrayAccess
{
	/**
	 * @var array $items Holds the collection items.
	 */
	 ...
	 * @return $this The current instance for method chaining.
	 */
	protected function arrayBreakdown(array $array, array &$flatArray, string $prefix = ''): self
	{
